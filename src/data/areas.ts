...
export const areaCities: AreaCity[] = [
  {
    ...
    lead:
      "大津市坂本に本社を置き、指定給水・排水設備工事事業者として地域の水廻りを支えています。漏水調査から配管工事、水廻りリフォームまでご相談ください。",
    services: ["漏水調査", "漏水修理", "排水工事", "給排水設備工事", "水廻りリフォーム"],
    commonRequests: [
      "水道料金増加に伴う漏水調査",
      "屋外排水管の改修",
      "トイレ・給湯器まわりの修繕",
  ...
  },
  {
    ...
    services: ["漏水修理", "排水工事", "給排水設備工事", "水廻りリフォーム"],
  ...
  },
  {
    ...
    lead: "湖南市の住宅・施設における水廻り工事、漏水対応をご相談いただけます。",
  ...
  },
  {
    ...
    lead: "長浜市での水廻り工事・漏水対応も、内容を伺いながらご案内します。",
    services: ["漏水修理", "排水工事", "給排水設備工事"],
